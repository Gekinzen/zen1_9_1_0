...
# Auto-refresh for nwg-dock-hyprland color theme (Pywal-integrated)
...
# ✅ Generate GTK-compatible CSS (no backdrop-filter)
cat > "$STYLE_FILE" <<EOF
/* Auto-generated by dock-manager.sh — Pywal Glass Theme */

@define-color background ${background}CC;   /* transparent */
@define-color bordercolor ${color0};
@define-color foreground ${foreground};
@define-color accent ${color12};
@define-color hovercolor ${color12}33;
