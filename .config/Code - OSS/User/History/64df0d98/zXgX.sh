...
ACTIVE_OPACITY=$(grep "active_opacity" "$HYPR_CONF" | awk '{print $3}')
...
# Create alpha variant (8-digit hex)
BG_ALPHA="${BG}${ALPHA}"
...
for THEME_FILE in "${THEME_FILES[@]}"; do
    ...
    # Update colors - separate patterns para sure
